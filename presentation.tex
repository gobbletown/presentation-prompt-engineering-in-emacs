...
\label{sec:org212095f}
\begin{frame}[label={sec:org9df7290},fragile]{Following along}
...
\label{sec:org0362a06}
\subsection{GPT-3}
\label{sec:org1e4d988}
\begin{frame}[label={sec:orgcac6903},fragile]{Text Generator}
...
\label{sec:orgcab79cc}
\begin{frame}[label={sec:orga670b33},fragile]{Prompt Engineering}
...
\label{sec:orgefd2100}
\subsection{}
\label{sec:orgabcd143}
\end{document}
