...
\label{sec:org5cf7201}
\begin{frame}[label={sec:org0e4750d},fragile]{Following along}
...
\label{sec:orgb56ee3d}
\subsection{GPT-3}
\label{sec:org9c74887}
\begin{frame}[label={sec:org5195dfb},fragile]{Text Generator}
...
\label{sec:org7ed3a2c}
\begin{frame}[label={sec:org938e97e},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgd087aad},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org12768cb}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orga32199a}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org3cac1b7}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgb788af3},fragile]{Design patterns}
...
\begin{frame}[label={sec:org296a803},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org6738e3c},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org5debbdf},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org33c6088},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org52ba9a1}]{Techniques}
...
\label{sec:org2a0dde7}
\subsection{Using \texttt{pen.el}}
\label{sec:org19658b7}
\begin{frame}[label={sec:org6d2dbc5},fragile]{\texttt{pen.el}}
 {\footnotesize
...
\begin{frame}[label={sec:orgdcc177b},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org3989476},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orga09f3a5},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org48a6794}
\subsection{\texttt{pen.el}}
\label{sec:org2ac7d31}
\begin{frame}[label={sec:org32cdc9e},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orge2e8bbf}
\begin{frame}[label={sec:org89d514c},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orga4bfb2d},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org81d4e2b}
\begin{frame}[label={sec:org177642c}]{Something funny}
...
\begin{frame}[label={sec:org9288bb2}]{Something funny}
...
\begin{frame}[label={sec:org3f5396c}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgcfc83a3}
\subsection{Additional reading}
\label{sec:org07b7266}
\begin{frame}[label={sec:org05d76b1}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
