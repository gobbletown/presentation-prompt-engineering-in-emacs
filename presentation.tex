...
\label{sec:orgda21123}
\begin{frame}[label={sec:orgce6ff50},fragile]{Following along}
...
\label{sec:org7b57f08}
\subsection{GPT-3}
\label{sec:org7729daf}
\begin{frame}[label={sec:org6b5bfe7},fragile]{Text Generator}
...
\label{sec:orgd5536fa}
\begin{frame}[label={sec:org3d56d95},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org2866d68},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org3c5a3e5}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgadfe819},fragile]{Design patterns}
 \begin{block}{\texttt{generate-vim-command.prompt}}
{\footnotesize
\begin{verbatim}
 1  Vim
...
\label{sec:org5d0969c}
\subsection{Using \texttt{pen.el}}
\label{sec:org4f55317}
\begin{frame}[label={sec:orgcba77e3},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org31ee74f},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgc62da57},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org08db41e}
\subsection{\texttt{pen.el}}
\label{sec:orgd373a88}
\begin{frame}[label={sec:orgc1dae32},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org0c55237}
\begin{frame}[label={sec:orge000801},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgb0a6dc1},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org438a260}
\begin{frame}[label={sec:orgcf218a2}]{Something funny}
...
\begin{frame}[label={sec:org3c766f5}]{Something funny}
...
\begin{frame}[label={sec:org5b7db37}]{Create a prompt}
...
\section{Appendix}
\label{sec:org8597582}
\subsection{Additional reading}
\label{sec:org8db5e16}
\begin{frame}[label={sec:org3adad69}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
