...
\label{sec:org04bbd95}
\begin{frame}[label={sec:org2b6a749},fragile]{Following along}
...
\label{sec:org54321ef}
\subsection{GPT-3}
\label{sec:org017dbf7}
\begin{frame}[label={sec:org01a178f},fragile]{Text Generator}
...
\label{sec:org2506454}
\subsection{A new programming paradigm}
\label{sec:orga6e15d5}
\begin{frame}[label={sec:orgdb7cce2}]{Prompt Engineering}
{\footnotesize
\begin{itemize}
\item declarative
\begin{itemize}
