...
\label{sec:org112594d}
\subsection{GPT-3}
\label{sec:orga621087}
\begin{frame}[label={sec:org559592f},fragile]{Text Generator}
...
\label{sec:org89bc6bf}
\begin{frame}[label={sec:org6308f79},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org8d5b648},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org483778f}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org0499638}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org23afd22}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org3d212ed},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgb6de185},fragile]{Design patterns}
 Taken from Prompt Design 101.
