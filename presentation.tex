...
\label{sec:org678c05b}
\begin{frame}[label={sec:org0992b30},fragile]{Following along}
...
\label{sec:org719698f}
\subsection{GPT-3}
\label{sec:org7e36234}
\begin{frame}[label={sec:orgf2a24a7},fragile]{Text Generator}
...
\label{sec:orgc387e16}
\begin{frame}[label={sec:orgdbce42a},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgf83a4d1},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org91ee9f6}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org76026df}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org690ac34}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org10ba12e},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgb3b221b},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org4acb413},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org8aaf00d},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org8443e31},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org5ba1ba3}]{Techniques}
...
\label{sec:orgf721c0a}
\subsection{Using \texttt{pen.el}}
\label{sec:orgfc4e9cf}
\begin{frame}[label={sec:org4261ec8},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org1bdb283}
\begin{frame}[label={sec:orgc7c9ef1},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org6519048}
\begin{frame}[label={sec:orga6cfdff},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org82aa712},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgece6d75},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orge4bfac9},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org89d2d10}
\subsection{\texttt{pen.el}}
\label{sec:org5c517e3}
\begin{frame}[label={sec:orgf478c71},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org9c0fb77}
\begin{frame}[label={sec:org3653972},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgbbe78e8},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgbb38be8}
\begin{frame}[label={sec:org636194f}]{Something funny}
...
\begin{frame}[label={sec:orgaa12353}]{Something funny}
...
\begin{frame}[label={sec:org58e17ef}]{Create a prompt}
...
\section{Appendix}
\label{sec:org875a6e2}
\subsection{Additional reading}
\label{sec:org857aacf}
\begin{frame}[label={sec:org7bb6b0a}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
