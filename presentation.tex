...
\label{sec:orge72c81e}
\begin{frame}[label={sec:orgd1daa9a},fragile]{Following along}
...
\label{sec:orge4902b8}
\subsection{GPT-3}
\label{sec:org6713f46}
\begin{frame}[label={sec:org5a8c286},fragile]{Text Generator}
...
\label{sec:org3bbffe5}
\begin{frame}[label={sec:org3cb5b32},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgb1d810f},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:orgcd5b18a}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org2f1747d}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgf4f1e2a}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org3105f30},fragile]{Design patterns}
...
\begin{frame}[label={sec:org53d70b8},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgc8b81ff},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org84c4f39},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org327c7b0},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org4bd505a}]{Techniques}
...
\label{sec:org31a5da3}
\subsection{Using \texttt{pen.el}}
\label{sec:org791e857}
\begin{frame}[label={sec:orgd9c5882},fragile]{\texttt{pen.el}}
...
\begin{block}{Modes}
{\footnotesize
\begin{block}{Prompt-Engineering Minor Mode}
...
\begin{block}{Prompt Description Major Mode}
...
\begin{frame}[label={sec:org54d3d4e},fragile]{\texttt{pen.el}}
 \begin{block}{Modes}
{\footnotesize
\begin{block}{Pen Messenger Minor Mode}
...
\begin{block}{Pen Conversation Mode}
...
\begin{frame}[label={sec:org3e48fe3},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org9ea95b8},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgc046d4e},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orge332cd7}
\subsection{\texttt{pen.el}}
\label{sec:org3dec51d}
\begin{frame}[label={sec:org69a693a},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org53743df}
\begin{frame}[label={sec:org7a2c425},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org06702ea},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgc8d4008}
\begin{frame}[label={sec:org59e02cc}]{Something funny}
...
\begin{frame}[label={sec:org1a049f0}]{Something funny}
...
\begin{frame}[label={sec:org59f3676}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgb7bb4c0}
\subsection{Additional reading}
\label{sec:orgf36568c}
\begin{frame}[label={sec:org369970c}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
