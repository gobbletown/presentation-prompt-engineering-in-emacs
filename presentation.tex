...
\label{sec:org432d4f7}
\begin{frame}[label={sec:org84432ac},fragile]{Following along}
...
\label{sec:orgec5242e}
\subsection{GPT-3}
\label{sec:orgef74e09}
\begin{frame}[label={sec:org9b189d8},fragile]{Text Generator}
...
\label{sec:orgdb2dab5}
\begin{frame}[label={sec:org9c7ea3e},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org75c8132},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org3866d43}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org3828825},fragile]{Design patterns}
 \begin{block}{\texttt{generate-vim-command.prompt}}
{\footnotesize
\begin{verbatim}
 1  Vim
...
\label{sec:orgad7251c}
\subsection{Using \texttt{pen.el}}
\label{sec:org6394de4}
\begin{frame}[label={sec:org9919c2b},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgcaa560b},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgb930e56},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org91f5436}
\subsection{\texttt{pen.el}}
\label{sec:org8a3a55a}
\begin{frame}[label={sec:org15007f7},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org8c795b3}
\begin{frame}[label={sec:org947b78b},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org9fc6e8f},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org5439ebe}
\begin{frame}[label={sec:org5a23081}]{Create a prompt}
...
\section{Appendix}
\label{sec:org8b35015}
\subsection{Additional reading}
\label{sec:orga02ea39}
\begin{frame}[label={sec:org7467769}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
