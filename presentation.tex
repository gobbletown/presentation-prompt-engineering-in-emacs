...
\label{sec:org79d2753}
\begin{frame}[label={sec:org88e3e7c},fragile]{Following along}
...
\label{sec:org3b5b644}
\subsection{GPT-3}
\label{sec:org18f6cef}
\begin{frame}[label={sec:orgf67e284},fragile]{Text Generator}
...
\label{sec:org41e5f0a}
\begin{frame}[label={sec:orge9373e9},fragile]{Prompt Engineering}
...
\label{sec:org9b43910}
\subsection{\texttt{pen.el}}
\label{sec:org870e3f0}
\begin{frame}[label={sec:org1e79fe2},fragile]{\texttt{Prompts as functions}}
\end{frame}

\subsection{\texttt{examplary}}
\label{sec:orgb697434}

\section{Demonstrations}
\label{sec:org91e5a8b}
\subsection{Using \texttt{pen.el}}
\label{sec:orgbaea4fa}
\begin{frame}[label={sec:org8641d6b},fragile]{Prompt YAML format}
 \begin{block}{Prompt YAML format: Part 1}
\begin{verbatim}
...
\begin{block}{Prompt YAML format: Part 2}
\begin{verbatim}
 1  top-p: 1
...
\begin{block}{Prompt YAML format: Part 3}
\begin{verbatim}
1  vars:
2  - "notes"
3  examples:
...
\begin{frame}[label={sec:org59ca7db},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org2d37fe6}]{Create a prompt}
...
\section{Appendix}
\label{sec:org9a603c3}
\subsection{Additional reading}
\label{sec:org57476b1}
\begin{frame}[label={sec:orga122a76}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
