...
\label{sec:orge114a60}
\begin{frame}[label={sec:org8044fe9},fragile]{Following along}
...
\label{sec:org2c13c72}
\subsection{GPT-3}
\label{sec:org7b6ee47}
\begin{frame}[label={sec:org032b19a},fragile]{Text Generator}
...
\label{sec:org0cad3b9}
\begin{frame}[label={sec:org9f4e503},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgd73c3e8},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:orgca3297b}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgb2412b6}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org0106b9a}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org6815358},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgb386922},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org2b96eb4},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org19b27b4},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org3055ae8},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgedd50ad}]{Techniques}
...
\label{sec:orgae803da}
\subsection{Using \texttt{pen.el}}
\label{sec:org2759e7c}
\begin{frame}[label={sec:org584fc92},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org81cd7a2},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org3f32e09},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orga76ad33}
\subsection{\texttt{pen.el}}
\label{sec:org9b065c6}
\begin{frame}[label={sec:org25ae642},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org1971578}
\begin{frame}[label={sec:org527c8a5},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgb27c69a},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org08f7b29}
\begin{frame}[label={sec:org6f0b2df}]{Something funny}
...
\begin{frame}[label={sec:orge66920c}]{Something funny}
...
\begin{frame}[label={sec:orgb521b52}]{Create a prompt}
...
\section{Appendix}
\label{sec:orga50608a}
\subsection{Additional reading}
\label{sec:org6424420}
\begin{frame}[label={sec:orgba0452b}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
