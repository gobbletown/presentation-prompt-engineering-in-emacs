...
\label{sec:orgc18ef50}
\begin{frame}[label={sec:org02098dc},fragile]{Following along}
...
\label{sec:org751a466}
\subsection{GPT-3}
\label{sec:org632afb5}
\begin{frame}[label={sec:orge03d98b},fragile]{Text Generator}
...
\label{sec:orga2ca5bc}
\begin{frame}[label={sec:org625466a},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgefba004},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org77c2ffd}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgb5fe47a},fragile]{Design patterns}
 \begin{block}{\texttt{generate-vim-command.prompt}}
{\footnotesize
\begin{verbatim}
 1  Vim
...
\label{sec:orgc0ce717}
\subsection{Using \texttt{pen.el}}
\label{sec:org1ad8504}
\begin{frame}[label={sec:org8e03869},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org8fa3dc5},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org17f5f34},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org84dd527}
\subsection{\texttt{pen.el}}
\label{sec:org5435422}
\begin{frame}[label={sec:org9348dec},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org974f2df}
\begin{frame}[label={sec:org14d2ef0},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgac9ab09},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org1d2d06f}
\begin{frame}[label={sec:org750df54}]{Something funny}
\begin{center}
\includegraphics[width=.9\linewidth]{./complicate.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org90e7ede}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgc269dfb}
\subsection{Additional reading}
\label{sec:orgc953f0e}
\begin{frame}[label={sec:orgd6acd4d}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
