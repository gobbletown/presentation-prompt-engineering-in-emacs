...
\label{sec:orge1dad22}
\begin{frame}[label={sec:orgd9ccd61},fragile]{Following along}
...
\label{sec:org1a4b891}
\subsection{GPT-3}
\label{sec:orgc91ac75}
\begin{frame}[label={sec:org3d52361},fragile]{Text Generator}
...
\label{sec:orga89659d}
\begin{frame}[label={sec:org5a08542},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org4947c48},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org32612e3}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org85a1a6d}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org0cfbe00}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org743acf3}]{Design patterns}
...
\begin{frame}[label={sec:org5ce5283},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org16948b1}]{Techniques}
...
\label{sec:orgb19f1ef}
\subsection{Using \texttt{pen.el}}
\label{sec:org039c220}
\begin{frame}[label={sec:orge015fef},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org57fc197},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org66b9040},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org4ec9af8}
\subsection{\texttt{pen.el}}
\label{sec:org325d54b}
\begin{frame}[label={sec:org8c86738},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org338547b}
\begin{frame}[label={sec:org79be64a},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org11039b4},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org3ef1880}
\begin{frame}[label={sec:org38ee604}]{Something funny}
...
\begin{frame}[label={sec:org40a0854}]{Something funny}
...
\begin{frame}[label={sec:org570b253}]{Create a prompt}
...
\section{Appendix}
\label{sec:org11395bc}
\subsection{Additional reading}
\label{sec:orgc7a2b8e}
\begin{frame}[label={sec:org65f6f38}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
