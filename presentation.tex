...
\label{sec:org7349050}
\begin{frame}[label={sec:org24b9d35},fragile]{Following along}
...
\label{sec:org7ac7c2d}
\subsection{GPT-3}
\label{sec:orgdc173f8}
\begin{frame}[label={sec:org97ac848},fragile]{Text Generator}
...
\label{sec:org7d5b69a}
\begin{frame}[label={sec:org4432f7b},fragile]{Prompt Engineering}
...
\label{sec:org1a2f991}
\subsection{\texttt{pen.el}}
\label{sec:orgf1d0f3e}
\begin{frame}[label={sec:org73bfc6c},fragile]{\texttt{Prompts as functions}}
\end{frame}

\subsection{\texttt{examplary}}
\label{sec:org97a613d}

\section{Demonstrations}
\label{sec:org34d881f}
\subsection{Using \texttt{pen.el}}
\label{sec:orge1853c2}
\begin{frame}[label={sec:org96e0ecc},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:orga59e442}]{Create a prompt}
