...
\label{sec:orgbe035c8}
\begin{frame}[label={sec:org1918d0b},fragile]{Following along}
...
\label{sec:org57499c3}
\subsection{GPT-3}
\label{sec:org65107df}
\begin{frame}[label={sec:orge4ea4a2},fragile]{Text Generator}
...
\label{sec:org2cc5088}
\begin{frame}[label={sec:orgc37ade0},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orge4040ae},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org53d4c3a}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org6b3e819}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgc65ceee}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org7c78e07},fragile]{Design patterns}
...
\begin{frame}[label={sec:org3c7626c},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgecb456f},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org91ac005},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgf42d82a},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org0c1e393}]{Techniques}
...
\label{sec:orgfda28bf}
\subsection{Using \texttt{pen.el}}
\label{sec:orgb5c575d}
\begin{frame}[label={sec:org9c9615f},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org39761e0},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org709ad41},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org2f1043a},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org1f1d62d},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org012de63},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orgaacb6bc}
\subsection{\texttt{pen.el}}
\label{sec:org93b4290}
\begin{frame}[label={sec:orgcdd10a3},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org1cf32b4}
\begin{frame}[label={sec:org89f65ea},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org23c6a4c},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgf34b073}
\begin{frame}[label={sec:org5fdb461}]{Something funny}
...
\begin{frame}[label={sec:org712dfdd}]{Something funny}
...
\begin{frame}[label={sec:orgf910259}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgaeb2cb5}
\subsection{Additional reading}
\label{sec:orgfc3f762}
\begin{frame}[label={sec:org864a994}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
