...
\label{sec:orgf6a6742}
\begin{frame}[label={sec:org48550d9},fragile]{Following along}
...
\label{sec:orga255729}
\subsection{GPT-3}
\label{sec:orgac8e9e4}
\begin{frame}[label={sec:orgda8a5a3},fragile]{Text Generator}
...
\label{sec:org53449ab}
\begin{frame}[label={sec:org13a5f6c},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org65a70fc},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org664af39}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org82b6fbb}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org795971a}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgd6f9475},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgb28636f},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{block}{Improving the classifier’s efficiency}
...
\begin{frame}[label={sec:org9dde39b}]{Techniques}
...
\label{sec:orgc228a95}
\subsection{Using \texttt{pen.el}}
\label{sec:org5d4d31d}
\begin{frame}[label={sec:org98d70f3},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgdc347c6},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org89c3337},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orgdf8d419}
\subsection{\texttt{pen.el}}
\label{sec:org7f57516}
\begin{frame}[label={sec:orgf7a7356},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org0319c50}
\begin{frame}[label={sec:org6255a45},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org4b5fb87},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgd7cb782}
\begin{frame}[label={sec:orgc4d770b}]{Something funny}
...
\begin{frame}[label={sec:org3b18677}]{Something funny}
...
\begin{frame}[label={sec:org35591a6}]{Create a prompt}
...
\section{Appendix}
\label{sec:org6cae577}
\subsection{Additional reading}
\label{sec:org01baad0}
\begin{frame}[label={sec:org284d4d9}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
