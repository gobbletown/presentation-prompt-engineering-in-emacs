...
\label{sec:orgb66e05c}
\begin{frame}[label={sec:orga83d5a4},fragile]{Following along}
...
\label{sec:org647ee3d}
\subsection{GPT-3}
\label{sec:org8fc8646}
\begin{frame}[label={sec:orge23ed45},fragile]{Text Generator}
...
\label{sec:org1c34e50}
\begin{frame}[label={sec:orgdd3e2a5},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orge15a6f3},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org5972857}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org31ae7dd}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgdfba10c}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgff2994d},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgea28234},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orge40e234},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgf68e8ca},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgbb7f4b4},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org8849c7d}]{Techniques}
...
\label{sec:orgddd59d9}
\subsection{Using \texttt{pen.el}}
\label{sec:orge5e337d}
\begin{frame}[label={sec:orgfbfa3cd},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org7175e54},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgbfd19c2},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org35f15ec}
\subsection{\texttt{pen.el}}
\label{sec:orgc33665e}
\begin{frame}[label={sec:orgfb29b0a},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org5ace372}
\begin{frame}[label={sec:org91daa0a},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org0dd56f1},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orga7834fa}
\begin{frame}[label={sec:org13191b3}]{Something funny}
...
\begin{frame}[label={sec:org4797a91}]{Something funny}
...
\begin{frame}[label={sec:orgf0b909b}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgbfab7ab}
\subsection{Additional reading}
\label{sec:orgd9010e3}
\begin{frame}[label={sec:org6193223}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
